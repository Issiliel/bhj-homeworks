...
rotator.forEach(container => {
const rotatorCases = container.querySelectorAll('.rotator__case');
const RotatorCaseActive = Array.from(rotatorCases).indexOf(container.querySelector('.rotator__case_active'));
...
changeRotator(RotatorCaseActive);
})